   ...
   // public Button unlockButton;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
        {
            ...
            GameObject character = Instantiate(CharacterManager.Instance.characters[i], centerPoint, Quaternion.Euler(originalRotation.x, originalRotation.y, originalRotation.z));
